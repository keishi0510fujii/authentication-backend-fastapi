FROM pypy:3.9-slim-buster as setup
...
COPY --from=setup --chown=$USERNAME:$GROUPNAME /opt/app /opt/app
COPY --from=setup --chmod=755 /opt/pypy/lib/pypy3.9/site-packages /opt/pypy/lib/pypy3.9/site-packages
